/**
 * Bus.java
 * [Defining Sub-class of Car.java: Bus.java]
...
public class Bus extends Car{
    ...
    public String printDescription(){
        ...
        if (getLongTripStatus()){
			CarStat += String.format(", memiliki kapasitas penumpang %d orang, dan digunakan untuk perjalanan jauh", getPassengerCapacity());
		}
		else{
			CarStat += String.format(", memiliki kapasitas penumpang %d orang, dan tidak digunakan untuk perjalanan jauh", getPassengerCapacity());
		}
		return CarStat;
